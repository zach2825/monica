<form method="POST" action="{{ $action }}">
    ...
    <div class="form-check">
      <label class="form-check-label" for="birthdateApproximate_unknown">
        <input type="radio" class="form-check-input" name="birthdate" id="birthdateApproximate_unknown" value="unknown"
        {{ is_null($kid->birthday_special_date_id)? ' checked ' : '' }}
        >
    ...
    <div class="form-check">
      <label class="form-check-label" for="birthdateApproximate_approximate">
        <input type="radio" class="form-check-input" name="birthdate" id="birthdateApproximate_approximate" value="approximate"
        {{ is_null($kid->birthday_special_date_id) ?' ' : ( $kid->birthdate->is_age_based == true ?' checked ' : '') }}
        >
    ...
    <div class="form-check">
      <label class="form-check-label" for="birthdateApproximate_exact">
        <input type="radio" class="form-check-input" name="birthdate" id="birthdateApproximate_exact" value="exact"
        {{ is_null($kid->birthday_special_date_id) ?' ' : ( $kid->birthdate->is_age_based == true ? '': ' checked ') }}
        >
